...
Drawer::Drawer(QWidget *parent, Qt::WindowFlags f)
    :QToolBox(parent,f)
{
    setWindowTitle(tr("QQ版本聊天软件"));                   //设置主窗体的标题
    setWindowIcon(QPixmap(":/images/qq.png"));              //设置主窗体标题栏图标

    toolBtn1 =new QToolButton;
    toolBtn1->setText(tr("小白熊"));
    toolBtn1->setIcon(QPixmap(":/images/p9.png"));
    ...
    toolBtn2->setText(tr("吴铭"));
    toolBtn2->setIcon(QPixmap(":/images/p8.png"));
    ...
    toolBtn3->setText(tr("吴天"));
    toolBtn3->setIcon(QPixmap(":/images/p7.png"));
    ...
    toolBtn4->setIcon(QPixmap(":/images/p6.png"));
    ...
    toolBtn5->setText(tr("赵洁"));
    toolBtn5->setIcon(QPixmap(":/images/p1.png"));
    toolBtn5->setIconSize(QSize(79,77));
    ...
    toolBtn6->setIcon(QPixmap(":/images/p5.png"));
    ...
    toolBtn7->setText(tr("罗菲"));
    toolBtn7->setIcon(QPixmap(":/images/p4.png"));
    ...
    toolBtn8->setText(tr("暖暖"));
    toolBtn8->setIcon(QPixmap(":/images/p3.png"));
    ...
    toolBtn9->setText(tr("菲菲"));
    toolBtn9->setIcon(QPixmap(":/images/p2.png"));
